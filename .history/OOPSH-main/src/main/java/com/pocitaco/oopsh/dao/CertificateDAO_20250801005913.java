...
public class CertificateDAO extends BaseDAO<Certificate, Integer> {
    ...
    protected Certificate elementToEntity(Element element) {
        ...
        certificate.setCandidateId(Integer.parseInt(element.getElementsByTagName("candidateId").item(0).getTextContent()));
        ...
        try {
            ...
            certificate.setIssuedDate(DATE_FORMAT.parse(dateStr));
        } catch (Exception e) {
    ...
    public List<Certificate> findByCandidateId(int candidateId) {
        ...
        try {
            ...
            for (int i = 0; i < nodes.getLength(); i++) {
                Element element = (Element) nodes.item(i);
                int elementCandidateId = Integer.parseInt(element.getElementsByTagName("candidateId").item(0).getTextContent());

...
public class ExamScheduleDAO {
    ...
    private void addScheduleToDocument(Document doc, Element root, ExamSchedule schedule) {
        ...
        scheduleElement.appendChild(
                createElement(doc, "registeredCandidates", String.valueOf(schedule.getRegisteredCandidates())));
        ...
        if (schedule.getCreatedDate() != null) {
            scheduleElement.appendChild(
                    createElement(doc, "createdDate", schedule.getCreatedDate().format(DATETIME_FORMATTER)));
        }

...
public class PermissionEditController extends BaseController {
    ...
    protected void loadInitialData() {
        ...
        if (permissionToEdit != null) {
            txtPermissionName.setText(permissionToEdit.getName());
            txtDescription.setText(permissionToEdit.getDescription());
            txtResource.setText(permissionToEdit.getResource());
        }
    }

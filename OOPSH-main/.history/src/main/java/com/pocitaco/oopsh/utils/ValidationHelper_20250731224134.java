...
public class ValidationHelper {
    ...
    /**
     * Validate password strength (minimum 6 characters, at least 1 letter and 1 number)
     */
    ...
    /**
     * Check if ID card already exists (placeholder - implement when User model has idCard field)
     */
    public static boolean isIdCardExists(String idCard, UserDAO userDAO) {
        // TODO: Implement when User model has idCard field
        return false;
    }

...
public class LoginController implements Initializable {
    ...
    private void addEntranceAnimations() {
        ...
        // Scale animation
        ScaleTransition scaleIn = new ScaleTransition(Duration.millis(600));
        ...
        // Slide animation
        TranslateTransition slideIn = new TranslateTransition(Duration.millis(700));
        slideIn.setFromY(30);
        slideIn.setToY(0);
        ...
        Timeline delayedStart = new Timeline(new KeyFrame(Duration.millis(200), e -> {
            if (btnLogin.getScene() != null) {
                fadeIn.setNode(btnLogin.getScene().getRoot());
                fadeIn.play();
            }
        }));
        delayedStart.play();
    ...
    private void startLoadingAnimation() {
        ...
        // Premium loading animation with color change
        btnLogin.setStyle(btnLogin.getStyle().replace("linear-gradient(to right, #3498DB, #2980B9)", "#95A5A6"));
        ...
        loadingGlow.setColor(Color.rgb(149, 165, 166, 0.4));
        loadingGlow.setRadius(12);
        loadingGlow.setSpread(0.3);
    ...
    private void stopLoadingAnimation() {
        ...
        // Reset button style to premium gradient
        btnLogin.setStyle(
                "-fx-background-color: linear-gradient(to right, #3498DB, #2980B9); -fx-background-radius: 8; -fx-text-fill: white; -fx-font-family: 'Segoe UI', 'Roboto', sans-serif; -fx-font-size: 16px; -fx-font-weight: 600; -fx-cursor: hand; -fx-border-color: transparent; -fx-effect: dropshadow(gaussian, rgba(52,152,219,0.3), 10, 0, 0, 3);");
    }

    private void showSuccessAnimation() {
        btnLogin.setText("✓ ĐĂNG NHẬP THÀNH CÔNG");
        btnLogin.setStyle(btnLogin.getStyle().replace("#95A5A6", "linear-gradient(to right, #27AE60, #229954)"));
        ...
        successBounce.setToX(1.08);
        successBounce.setToY(1.08);
        ...
        successGlow.setColor(Color.rgb(39, 174, 96, 0.6));
        successGlow.setRadius(15);
        successGlow.setSpread(0.4);
        btnLogin.setEffect(successGlow);
    }

    private void showErrorAnimation() {
        btnLogin.setText("✗ ĐĂNG NHẬP THẤT BẠI");
        btnLogin.setStyle(btnLogin.getStyle().replace("#95A5A6", "linear-gradient(to right, #E74C3C, #C0392B)"));
        ...
        errorGlow.setColor(Color.rgb(231, 76, 60, 0.6));

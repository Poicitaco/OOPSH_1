...
public class RegistrationDAO extends BaseDAO<Registration, Integer> {
    ...
    protected Registration elementToEntity(Element element) {
        ...
        registration.setExamTypeId(Integer.parseInt(element.getElementsByTagName("examTypeId").item(0).getTextContent()));
        ...
        try {
            ...
            registration.setRegistrationDate(DATE_FORMAT.parse(dateStr));
        } catch (Exception e) {
    ...
    protected Element entityToElement(Document doc, Registration registration) {
        ...
        registrationDateElement.setTextContent(DATE_FORMAT.format(registration.getRegistrationDate()));

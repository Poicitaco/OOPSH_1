...
public class DashboardOverviewController extends BaseDashboardController {
    ...
    private void handleExamRegistration() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pocitaco/oopsh/candidate/register-exam.fxml"));
    ...
    private void handleResultsView() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pocitaco/oopsh/candidate/view-results.fxml"));
            Parent root = loader.load();
    ...
    private void handleMaterialsView() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pocitaco/oopsh/candidate/study-materials.fxml"));
            Parent root = loader.load();
    ...
    private void handlePracticeView() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pocitaco/oopsh/candidate/practice-tests.fxml"));
            Parent root = loader.load();

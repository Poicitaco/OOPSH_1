...
public class StudyMaterialDAO {
    ...
    private void addStudyMaterialToDocument(Document doc, Element root, StudyMaterial material) {
        ...
        materialElement.appendChild(createElement(doc, "createdDate", material.getCreatedDate().format(DATETIME_FORMATTER)));
    ...
    private StudyMaterial parseStudyMaterialFromElement(Element materialElement) {
        ...
        material.setCreatedDate(LocalDateTime.parse(getElementText(materialElement, "createdDate"), DATETIME_FORMATTER));

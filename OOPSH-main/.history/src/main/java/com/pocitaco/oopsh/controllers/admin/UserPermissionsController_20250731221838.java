...
public class UserPermissionsController extends BaseController {
    ...
    private void setupTable() {
        ...
        // functionalityCell.setComparator(...); // Commented out due to MaterialFX
        // compatibility

        tblPermissions.getTableColumns().addAll(
                // new io.github.palexdev.materialfx.controls.MFXTableColumn<>("Role", true,
                // roleCell),
                // new io.github.palexdev.materialfx.controls.MFXTableColumn<>("Functionality",
                // true, functionalityCell),
                createHasAccessColumn(),
                createActionsColumn());
    }

    private io.github.palexdev.materialfx.controls.MFXTableColumn<Permission> createHasAccessColumn() {
        io.github.palexdev.materialfx.controls.MFXTableColumn<Permission> hasAccessColumn = // new
                                                                                            // io.github.palexdev.materialfx.controls.MFXTableColumn<>("Has
                                                                                            // Access", true, null);
    ...
    private io.github.palexdev.materialfx.controls.MFXTableColumn<Permission> createActionsColumn() {
        io.github.palexdev.materialfx.controls.MFXTableColumn<Permission> actionsColumn = // new
    ...
    private void handleAddPermission() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/pocitaco/oopsh/admin/permission-create.fxml"));
    ...
    private void handleEditPermission(Permission permission) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/pocitaco/oopsh/admin/permission-edit.fxml"));
            Parent root = loader.load();

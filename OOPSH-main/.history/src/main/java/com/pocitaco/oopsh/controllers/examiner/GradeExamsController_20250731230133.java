...
public class GradeExamsController extends BaseController {
    ...
    @FXML private TableColumn<Registration, Integer> colId;
    @FXML private TableColumn<Registration, String> colCandidateName;
    @FXML private TableColumn<Registration, String> colExamType;
    @FXML private TableColumn<Registration, String> colRegistrationDate;
    @FXML private TableColumn<Registration, String> colStatus;
    @FXML private TableColumn<Registration, String> colActions;
    
    @FXML private TextField txtScore;
    @FXML private TextArea txtComments;
    @FXML private Button btnSaveGrade;
